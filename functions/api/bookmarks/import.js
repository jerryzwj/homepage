      ...
      for (const bookmark of bookmarks) {
        ...
        if (categoryMap.has(categoryName)) {
          ...
          const newCategoryResult = await db.prepare(
            'INSERT INTO categories (user_id, cate_name, cate_desc, sort, is_public, create_time, update_time) VALUES (?, ?, ?, 0, 0, CURRENT_TIMESTAMP, CURRENT_TIMESTAMP)'
          ).bind(userId, categoryName, '').run();
